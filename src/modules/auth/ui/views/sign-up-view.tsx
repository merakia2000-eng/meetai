...
export const SignUpView = () => {
    ...
    return (
        <div className="flex flex-col gap-6 max-w-2xl mx-auto"> {/* 加上 max-w-2xl 和居中 */}
            <Card className="overflow-hidden p-0">
                <CardContent className="grid grid-cols-2 p-0">
                        ...
                        <form onSubmit={form.handleSubmit(onSubmit)} className="p-6 md:p-8">
                            <div className="flex flex-col gap-6">
                                <div className="flex flex-col items-center text-center">
                                    <h1 className="text-2xl font-bold">Let&apos;s get startsd</h1>
                    ...
                    <div className="bg-gradient-to-r from-green-700 to-green-900 relative hidden
